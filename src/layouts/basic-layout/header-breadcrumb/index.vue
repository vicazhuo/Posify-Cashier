<template>
  <Breadcrumb class="i-layout-header-breadcrumb" ref="breadcrumb">
    <!--<BreadcrumbItem>-->
...
export default {
  ...
  computed: {
    ...mapState("store/layout", ["showBreadcrumbIcon", "menuCollapse"]),
    ...mapState("store/menu", [
      "openNames",
      "activePath",
      "header",
  ...
  async created() {
    ...
    let menuSider = this.$store.state.store.menus.menusName;
